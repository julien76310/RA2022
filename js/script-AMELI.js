...
$.when(
  ...
  $.getJSON('https://raw.githubusercontent.com/julien76310/RA2022/main/geodata_files/JSON/DATA_AMELI.json')
    ...
    elem2.innerHTML = 'Référence pour le département : '+taux_departement +'%';
    ...
    geojson.features.forEach(function (item) {
      ...
      item.properties.pourcent = parseFloat(data[index]["TAUX_BENEF"].replace(",", "."));
